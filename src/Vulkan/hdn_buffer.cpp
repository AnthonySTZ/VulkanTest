 ...
 */
  ...
  */
    ...
    HdnBuffer::~HdnBuffer() {
    unmap();
    vkDestroyBuffer(hdnDevice.device(), buffer, nullptr);
    vkFreeMemory(hdnDevice.device(), memory, nullptr);
    }
    ...
    return vkMapMemory(hdnDevice.device(), memory, offset, size, 0, &mapped);
    }
    ...
    if (mapped) {
        vkUnmapMemory(hdnDevice.device(), memory);
        mapped = nullptr;
    }
    }
    ...
    return vkFlushMappedMemoryRanges(hdnDevice.device(), 1, &mappedRange);
    }
    ...
    mappedRange.offset = offset;
    mappedRange.size = size;
    return vkInvalidateMappedMemoryRanges(hdnDevice.device(), 1, &mappedRange);
    }
